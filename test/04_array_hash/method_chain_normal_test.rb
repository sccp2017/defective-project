...
def test_method_chain2_1
  actual = method_chain2(['abcdef', 'ghijkl', 'mnopqr'])
  expected = ["FED", "LKJIHG", "RQPONM"]

  assert_equal expected, actual
end

def test_method_chain2_2
  actual = method_chain2(['aaabbbccc', '?cbabcebacvbbclbaocbascba cbaubacoby abcbabcbabcdabcbicbabcdbac'])
